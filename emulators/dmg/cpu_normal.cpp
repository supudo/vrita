...
void DMG_CPU::executeInstruction8bit(bool ROMFileLoaded, uint8_t opcode) {
    ...
    switch (opcode) {
        ...
        case 0xC0: // RET NZ
            ...
            break;
        case 0xC1: // POP BC
            Registers.BC = mmu.readStack(&Registers.SP);
            break;
        case 0xC2: // JP NZ, nn
        ...
        case 0xC5: // PUSH BC
            mmu.tick(4);
            mmu.writeStack(&Registers.SP, Registers.BC);
            break;
        case 0xC6: // ADD A, n
        ...
        case 0xD1: // POP DE
            ...
            Registers.DE = mmu.readStack(&Registers.SP);
            break;
        case 0xD2: // JP NC, nn
        ...
        case 0xD5: // PUSH DE
            ...
            mmu.tick(4);
            mmu.writeStack(&Registers.SP, Registers.DE);
            break;
        case 0xD6: // SUB n
        ...
        case 0xE1: // POP HL
            ...
            Registers.HL = mmu.readStack(&Registers.SP);
            break;
        ...
        case 0xE5: // PUSH HL
            ...
            mmu.tick(4);
            mmu.writeStack(&Registers.SP, Registers.HL);
            break;
        case 0xE6: // AND n
        ...
        case 0xF1: // POP AF
            ...
            Registers.AF = mmu.readStack(&Registers.SP);
        ...
        case 0xF5: // PUSH AF
            ...
            mmu.tick(4);
            mmu.writeStack(&Registers.SP, Registers.AF);
            break;
        case 0xF6: // OR n
